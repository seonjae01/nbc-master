...
void ANBC_MasterCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANBC_MasterCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ANBC_MasterCharacter::Look);
	...
	{
		UE_LOG(LogNBC_Master, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ANBC_MasterCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANBC_MasterCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANBC_MasterCharacter::DoMove(float Right, float Forward)
{
...
void ANBC_MasterCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ANBC_MasterCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ANBC_MasterCharacter::DoJumpEnd()
{
